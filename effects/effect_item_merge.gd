...
func apply(player_index: int) -> void:
	FengLiuUtils.bind_effect(custom_key_hash, player_index, [key_hash, value, merge_from_item_hash, merge_from_count, merge_to_item_hash, merge_to_item_count])
	

func unapply(player_index: int) -> void:
	FengLiuUtils.unbind_effect(custom_key_hash, player_index, [key_hash, value, merge_from_item_hash, merge_from_count, merge_to_item_hash, merge_to_item_count])
